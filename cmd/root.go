...
import (
	...
	"github.com/gkwa/leadyspleen/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.leadyspleen.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".leadyspleen")
	}
